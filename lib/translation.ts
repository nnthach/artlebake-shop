    ...
    admin: {
      ...
      preorderItemPage: {
        headerTitle: {
          ...
          subtitle: "Manage scheduled products and their remaining quantities.",
        },
        table: {
          columns: {
            image: "Image",
        ...
        createModal: {
          ...
          fields: {
            ...
            schedulePlaceholder: "Select a pre-order date",
            scheduleLoading: "Loading dates...",
            scheduleEmpty: "No open pre-order dates available.",
            product: "Product",
            productPlaceholder: "Select product",
            productLoading: "Loading products...",
            productEmpty: "No active products available.",
            quantity: "Quantity",
            addProduct: "Add product",
            failedLoadSchedules: "Failed to load pre-order schedules.",
            failedLoadProducts: "Failed to load products.",
          },
          errors: {
            scheduleRequired: "Please select a pre-order date.",
            productRequired: "Product is required.",
            productDuplicate: "This product has already been selected.",
      ...
      productsPage: {
        ...
        createModal: {
          ...
          fields: {
            ...
            price: "Price (VND)",
            bestseller: "Bestseller",
            markAsBestseller: "Mark as bestseller",
            descriptionVi: "Description (VI)",
            descriptionEn: "Description (EN)",
            category: "Category",
  ...
  vi: {
    ...
    orderPage: {
      ...
      result: {
        ...
        items: "Sản Phẩm",
        deliveryInfo: "Thông Tin Khách Hàng",
        store: "Cửa Hàng",
      },
    ...
    admin: {
      ...
      preorderItemPage: {
        headerTitle: {
          ...
          subtitle:
            "Quản lý sản phẩm đã lên lịch đặt trước và số lượng còn lại.",
        },
        table: {
          columns: {
            image: "Hình ảnh",
        ...
        createModal: {
          ...
          submit: "Tạo",
          fields: {
            scheduleDate: "Ngày đặt trước",
            schedulePlaceholder: "Chọn ngày đặt trước",
            scheduleLoading: "Đang tải ngày...",
            scheduleEmpty: "Chưa có ngày đặt trước nào đang mở.",
            product: "Sản phẩm",
            productPlaceholder: "Chọn sản phẩm",
            productLoading: "Đang tải sản phẩm...",
            productEmpty: "Chưa có sản phẩm đang hoạt động.",
            quantity: "Số lượng",
            addProduct: "Thêm sản phẩm",
            failedLoadSchedules: "Không tải được lịch đặt trước.",
            failedLoadProducts: "Không tải được sản phẩm.",
          },
          errors: {
            scheduleRequired: "Vui lòng chọn ngày đặt trước.",
            productRequired: "Sản phẩm là bắt buộc.",
            productDuplicate: "Sản phẩm này đã được chọn.",
            quantityInvalid: "Số lượng phải từ 0 trở lên.",
          },
          messages: {
      ...
      productsPage: {
        ...
        createModal: {
          ...
          fields: {
            ...
            price: "Giá (VND)",
            bestseller: "Bán chạy",
            markAsBestseller: "Đánh dấu là bán chạy",
            descriptionVi: "Mô tả (VI)",
            descriptionEn: "Mô tả (EN)",
            category: "Danh mục",
