...
export default function Filter({
  ...
  const statusOptions = [
    ...
    { label: t("admin.ingredientsPage.filter.options.active"), value: "true" },
    {
  ...
  const sortByOptions = [
    ...
    {
      label: t("admin.ingredientsPage.filter.options.name"),
      value: "name",
    },
  ];
  ...
  return (
    <div className="flex items-center justify-between border-b border-zinc-100 px-4 py-4">
      ...
      <CreateIngredientModal onCreated={onCreated} />
    </div>
  );
}
